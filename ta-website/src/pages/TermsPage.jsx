...
const SECTIONS = [
  { title: '1. Acceptance of Terms',      content: 'By accessing or using TeacherAttendance ("the Platform"), you agree to be bound by these Terms and Conditions. If you do not agree, do not use the Platform.' },
  { title: '2. Description of Service',   content: 'TeacherAttendance is a multi-tenant SaaS platform providing GPS, WiFi, QR, and selfie-verified teacher attendance management for schools. The platform includes a mobile app, school admin dashboard, and super admin panel.' },
  ...
  { title: '5. Data Ownership',           content: 'Schools retain ownership of their attendance data. TeacherAttendance is a data processor acting on behalf of each school. We do not claim ownership of school data and will not use it for purposes beyond platform operation.' },
