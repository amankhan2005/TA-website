...
const SECTIONS = [
  ...
  { title: '2. Description of Service',   content: 'TeacherAttendance is a multi-tenant SaaS school management platform providing administration, admissions, academics, GPS/WiFi/QR/selfie/RFID-verified attendance, student management, fee management, parent communication, and reporting for schools. The platform includes a mobile app, school admin dashboard, and super admin panel.' },
  ...
  { title: '5. Data Ownership',           content: 'Schools retain ownership of their attendance, student, staff, and fee data. TeacherAttendance is a data processor acting on behalf of each school. We do not claim ownership of school data and will not use it for purposes beyond platform operation.' },
